...
<div style="max-width: 600px; margin: 0 auto;">
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 24px;">
        ...
        <h2 style="margin: 0; color: #0b2a5a;">Add New Item</h2>
    </div>

    <form method="POST" action="{{ route('items.store') }}" style="background: white; padding: 24px; border-radius: 12px; border: 1px solid #d8e2f2; box-shadow: 0 4px 6px -1px rgba(16, 34, 62, 0.1);">
        @csrf
